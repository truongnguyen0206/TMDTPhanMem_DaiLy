...
// Dữ liệu giả lập
const lineChartData = [
  { name: '2015', "Đã thanh toán": 32, "Đã hủy": 40 },
  { name: '2016', "Đã thanh toán": 35, "Đã hủy": 28 },
  { name: '2017', "Đã thanh toán": 48, "Đã hủy": 38 },
  { name: '2018', "Đã thanh toán": 35, "Đã hủy": 50 },
  { name: '2019', "Đã thanh toán": 45, "Đã hủy": 30 },
  { name: '2020', "Đã thanh toán": 55, "Đã hủy": 42 },
];
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard title={t('npp.dashboard.agents')} value="50">
                ...
                <StatCard title={t('npp.dashboard.orders')} value="1,565k">
                    <ResponsiveContainer width="100%" height="100%">
                ...
                <div style={{ width: '100%', height: 300 }}>
                    <ResponsiveContainer>
                        <LineChart data={lineChartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                            ...
                            <Tooltip />
                            <Legend />
                            <Line type="monotone" dataKey="Đã thanh toán" name={t('npp.dashboard.dataKey1')} stroke="#8884d8" strokeWidth={3} activeDot={{ r: 8 }} />
                            <Line type="monotone" dataKey="Đã hủy" name={t('npp.dashboard.dataKey2')} stroke="#F87171" strokeWidth={3} />
                        </LineChart>
                    </ResponsiveContainer>
                </div>
            </div>
