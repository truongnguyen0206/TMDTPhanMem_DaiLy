    ...
    useEffect(() => {
        ...
        const fetchAgents = async () => {
            ...
            try {
                ...
                // Lọc ra những user có vai trò là 'Đại lý'
                const agentData = response.data.filter(user => user.role_name === 'Đại lý');
                                    ...
                                    <tr key={agent.user_id} className="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-4">
                                                ...
                                                <Link to={`/agents/edit/${agent.user_id}`} className="text-gray-400 hover:text-green-600">
                                                    <LuPencil size={18} />
                                                </Link>
                                                <button className="text-gray-400 hover:text-red-600"><LuTrash2 size={18} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
